...
const logInV2 = document.getElementById('login-btnV2');
  ...
  function status() {
    ...
    if (document.getElementById('terms-policy').checked) {
      ...
      function signupEmployee() {
        const url = '/v1/auth/employee-signup';
      ...
      showAlert(
        'Please fill required and/or accept the Terms and Conditions to proceed',
      );
      submitButton.innerText = 'Sign Up';
    }
  }
...
function checkInputs() {
  ...
  const passwordTwo = document.getElementById('confirmPassword').value.trim();
  const validCheck = document.getElementById('terms-policy').checked;

  document.querySelector('.needs-validation').classList.add('was-validated');

  if (!validCheck) {
    document.getElementById('invalidCheck').innerHTML =
      '* Please check the terms & policy conditions';
  } else {
  ...
  if (password === '') {
    ...
    checkPass(
      password,
      '* Password must contain a minimum of 8 characters, a capital letter, a number and special character',
    );
  } else {
...
submitButtonV2.addEventListener('click', (e) => {
  ...
  function statusV2() {
    const firstName = document.getElementById('fnameV2').value;
    const lastName = document.getElementById('lnameV2').value;
    const email = document.getElementById('emailV2').value;
    const phone = document.getElementById('phoneV2').value;
...
function checkInputsV2() {
  const firstName = document.getElementById('fnameV2').value.trim();
  const lastName = document.getElementById('lnameV2').value.trim();
  ...
  const passwordTwo = document.getElementById('confirmPasswordV2').value.trim();
  const validCheck = document.getElementById('terms-policyV2').checked;

  document.querySelector('.needs-validation').classList.add('was-validated');

  if (!validCheck) {
    document.getElementById('invalidCheckV2').innerHTML =
      '* Please check the terms & policy conditions';
  } else {
